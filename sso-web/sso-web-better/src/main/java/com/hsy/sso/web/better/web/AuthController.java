...
public class AuthController extends BaseController {
    ...
    @RequestMapping(value = {"/v1/permissions/list"},method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ResponseBodyBean<Object> getAllPermission() throws Exception{
        return success(ssoPermissionService.getAllPermisstion()) ;
    }

    @RequestMapping(value = {"/v2/permissions/list","/v2/permission/list/{offset}/{limit}"},method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @RequestMapping(value = "/v1/permission/list/{userId}",method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @RequestMapping(value = "/v1/permission/add",method = RequestMethod.POST,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @RequestMapping(value = "/v1/permission/update/{id}",method = RequestMethod.PUT,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @RequestMapping(value = "/v1/permission/delete/{id}",method = RequestMethod.DELETE,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @RequestMapping(value = {"/v1/role/list","/v1/role/list/{offset}/{limit}"},method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @RequestMapping(value = {"/v1/role/add"},
    ...
    @RequestMapping(value = {"/v1/role/update/{id}"},
            method = RequestMethod.POST,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @RequestMapping(value = {"/v1/role/delete/{id}"},
            method = RequestMethod.POST,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
